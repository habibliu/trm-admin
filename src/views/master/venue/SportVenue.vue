<template>
  <section>
    ...
    <!--列表-->
    <el-table :data="venues" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
    ...
    methods: {
      ...
      batchRemove: function () {
        ...
        this.$confirm('确认删除选中记录吗？', '提示', {
          ...
          //NProgress.start();
          let para = { ids: ids };
          batchRemoveVenue(para).then((res) => {
